...
export const AnalysisHistory: React.FC<AnalysisHistoryProps> = ({ history, onSelectItem, onClearHistory, selectedId }) => {
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          <HistoryIcon className="w-7 h-7 mr-3 text-slate-500" />
      ...
      <div className="max-h-96 overflow-y-auto pr-2 -mr-2">
        {history.length === 0 ? (
          <p className="text-center text-slate-500 py-8">No past analyses found.</p>
        ) : (
